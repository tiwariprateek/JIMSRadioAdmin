...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nav_layout=(LinearLayout)findViewById(R.id.frag_main);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_mod_show) {
            ...
            Toast.makeText(this, "Loading ratings...", Toast.LENGTH_SHORT).show();
            nav_layout.removeAllViews();
            getSupportFragmentManager().beginTransaction()
                    .replace(R.id.frag_main, new FragmentRating()).commit();
        }else{
